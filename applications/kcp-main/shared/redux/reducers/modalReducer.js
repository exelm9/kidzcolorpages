...
export default function modalReducer(state = initialState, action) {
  switch (action.type) {
    case SHOW_MODAL:
      return { ...state, show: true, collectionData: action.collectionData, collections: action.collections, colIdx: action.colIdx, aliases: action.aliases, imgIdx: action.imgIdx };
    case HIDE_MODAL:
